...
public class GridMonster
{
	public static void main(String[] args)
	{
		...
		block.putSelfInGrid(grid2, new Location(1, 0));
		display.showBlocks();
		block.setColor(Color.ORANGE);
		block.putSelfInGrid(grid2, new Location(1, 1));
		display.showBlocks();
		block.setColor(Color.ORANGE);
		block.putSelfInGrid(grid2, new Location(1, 2));
		display.showBlocks();
		block.setColor(Color.ORANGE);
		block.putSelfInGrid(grid2, new Location(1, 3));
		display.showBlocks();
		block.setColor(Color.ORANGE);
		block.putSelfInGrid(grid2, new Location(1, 4));
		display.showBlocks();
		block.setColor(Color.ORANGE);
		block.putSelfInGrid(grid2, new Location(2, 0));
		display.showBlocks();
		block.setColor(Color.ORANGE);
		block.putSelfInGrid(grid2, new Location(2, 1));
		display.showBlocks();
		block.setColor(Color.BLACK);
		block.putSelfInGrid(grid2, new Location(0, 1));
		display.showBlocks();
